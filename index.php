...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700&display=swap" rel="stylesheet"><script src="assets/js/main.js" defer></script>
<title>Sign up</title>
</head>
<body>
    ...
    <div class="container">
        <div class="sign_up">
            ...
            <div class="sign-up-content">
                <form class="signForm" method="POST" name="send">
                    <label>Имя</label><br>
                ...
                if(isset($_POST['send'])){
                    ...
                    $error = validateForm($name, $email, $phone_number);
                    if ($error) {
                        echo $error;
                    } else {
                        echo '<p class="error">успешно</p>';
                    } 
